...
<script>
  ...
  export default {
    ...
    methods: {
      init() {
        this.open = true
        this.deep = new Deep(this.$refs.deep, this.$refs.toolTips, this.buy, this.sell, this.$t(`depth.priceLabel`), this.$t(`depth.sumLabel`), {price: this.com.pxUnit ? this.com.pxUnit - 1 : this.com.pxUnit, size: this.com.qtyUnit}, Number(this.productinfo.depth_round))
      },
      toggle() {
        this.open = !this.open
      },
